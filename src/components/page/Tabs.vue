...
import vm from '../../utils/utils.js';
    export default {
        ...
        mounted() {
            var that=this;
            this.unread = JSON.parse(localStorage.getItem('inf'));
            console.log(this.unread);
            vm.$on('totab', function (msg) {
                that.unread = JSON.parse(localStorage.getItem('inf'));
            })
        ...
        methods: {
            handleRead(index) {
                ...
                localStorage.setItem('inf', JSON.stringify(this.unread));
                vm.$emit('test', 'h');
